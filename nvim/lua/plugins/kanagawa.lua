      ...
      require("kanagawa").setup {
        ...
        overrides = function(colors)
          ...
          return {
            ...
            TelescopePromptBorder = { bg = theme.ui.bg, fg = palette.crystalBlue },
            TelescopePromptTitle = { bg = palette.crystalBlue, fg = theme.ui.bg, bold = true },
            TelescopePromptPrefix = { bg = theme.ui.bg, fg = palette.crystalBlue },
            TelescopeResultsNormal = { bg = theme.ui.bg, fg = theme.ui.fg },
            TelescopeResultsBorder = { bg = theme.ui.bg, fg = theme.ui.nontext },
            TelescopeResultsTitle = { bg = theme.ui.bg, fg = theme.ui.fg },
            TelescopePreviewNormal = { bg = theme.ui.bg, fg = theme.ui.fg },
            TelescopePreviewBorder = { bg = theme.ui.bg, fg = theme.ui.nontext },
            ...
            TelescopeSelectionCaret = { fg = palette.crystalBlue, bold = true },
