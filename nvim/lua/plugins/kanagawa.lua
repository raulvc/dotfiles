      ...
      require("kanagawa").setup {
        ...
        overrides = function(colors)
          ...
          return {
            ...
            TelescopePromptBorder = { bg = theme.ui.bg_p1, fg = theme.ui.bg_p2 },
            TelescopePromptTitle = { bg = palette.crystalBlue, fg = theme.ui.bg, bold = true },
            TelescopePromptPrefix = { bg = theme.ui.bg_p1, fg = palette.crystalBlue },
            TelescopePromptCounter = { fg = theme.ui.nontext },
            TelescopeResultsNormal = { bg = theme.ui.bg, fg = theme.ui.fg_dim },
            TelescopeResultsBorder = { bg = theme.ui.bg, fg = theme.ui.bg_p1 },
            TelescopeResultsTitle = { bg = palette.oniViolet, fg = theme.ui.bg, bold = true },
            TelescopePreviewNormal = { bg = theme.ui.bg, fg = theme.ui.fg },
            ...
            TelescopeMultiIcon = { fg = palette.springBlue, bold = true },
            TelescopeMatching = { fg = palette.surimiOrange, bold = true },
            TelescopeResultsLineNr = { fg = theme.ui.nontext },
            ...
            -- NvimTree
            NvimTreeNormal = { bg = theme.ui.bg_m1, fg = theme.ui.fg_dim },
            NvimTreeNormalNC = { bg = theme.ui.bg_m1, fg = theme.ui.fg_dim },
            NvimTreeCursorLine = { bg = theme.ui.bg_p1 },
            NvimTreeWinSeparator = { fg = theme.ui.bg_m1, bg = theme.ui.bg_m1 },
            NvimTreeIndentMarker = { fg = theme.ui.bg_p2 },
            NvimTreeRootFolder = { fg = palette.oniViolet, bold = true },
            NvimTreeFolderIcon = { fg = palette.crystalBlue },
            NvimTreeFolderName = { fg = palette.crystalBlue },
            NvimTreeOpenedFolderName = { fg = palette.crystalBlue, bold = true },
            NvimTreeEmptyFolderName = { fg = palette.fujiGray },
            NvimTreeSymlink = { fg = palette.springBlue },
            NvimTreeExecFile = { fg = palette.springGreen, bold = true },
            NvimTreeImageFile = { fg = palette.surimiOrange },
            NvimTreeSpecialFile = { fg = palette.carpYellow, underline = true },
            NvimTreeGitDirty = { fg = palette.autumnRed },
            NvimTreeGitStaged = { fg = palette.autumnGreen },
            NvimTreeGitMerge = { fg = palette.autumnYellow },
            NvimTreeGitRenamed = { fg = palette.autumnYellow },
            NvimTreeGitNew = { fg = palette.autumnGreen },
            NvimTreeGitDeleted = { fg = palette.autumnRed },
            NvimTreeGitIgnored = { fg = palette.fujiGray },
            NvimTreeOpenedFile = { fg = theme.ui.fg, bold = true },
            NvimTreeModifiedFile = { fg = palette.carpYellow },
          }
        end,
